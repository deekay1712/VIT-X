...
import com.example.vit_x.ui.alumniProfile.AlumniProfileActivity;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewAdapter> {
    ...
    public void onBindViewHolder(@NonNull PostViewAdapter holder, int position) {
        ...
        //set on click on post -> alumni profile
        holder.postHeader.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context, AlumniProfileActivity.class);
